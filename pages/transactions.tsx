      ...
      <div ref={scrollToTop}>
        {userTransactions.length > 0 ? (
                      ...
                      >
                        ...
                        >
                          <div className="mr-10 flex min-w-[350px] flex-[1.3] flex-shrink-0 items-center pr-8 lg:pr-4">
                            <div>
                              <div className="flex items-center justify-center whitespace-nowrap font-medium text-socket-success">
                          ...
                          <div className="hidden min-w-[330px] flex-1 flex-shrink-0 sm:block">
                            ...
                            <div className="flex items-center">
                              ...
                              {userData.attributes.transaction_success && (
                                <a
                            ...
                            {userData.attributes.status === "Flip Success" && (
                              <div className="flex items-center mt-1">
                                ...
                                <a
                                  className="animated-glow"
                                  href={`${userData.attributes.receipt}`}
                                  target="_blank"
                                >
                                  <span className="flex">
                                    <svg
                          ...
                          <div className="hidden min-w-[330px] flex-1 flex-shrink-0 sm:block">
                            <div className="mb-1.5 flex items-center">
                              ...
                              <div className="ml-1.5 flex items-center font-semibold text-socket-primary">
                                ...
                                <span className="pl-1">
                                  <span className="flex flex-nowrap items-center whitespace-nowrap">
                                    {userData.attributes.receive?.toLocaleString(
                                      "en-US"
                                    ) ??
                                      userData.attributes.idr_value?.toLocaleString(
                                        "en-US"
                                      ) ??
                                      ""}{" "}
                                    IDR
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <div>
                              <span className="flex items-start justify-start font-semibold capitalize text-socket-primary">
                                <span className="flex items-center justify-start text-sm font-medium text-socket-success">
                                  <div className="mr-[7px]">
                                    <svg
                                      width="15"
                                      height="15"
              ...
              <div className="w-full justify-center items-center mt-5 mx-auto">
                ...
                >
                  <Pagination
                    ...
                    pageSize={
                      transactionsData?.data.meta.pagination.pageSize ?? 0
                    }
          ...
          >
            <img
              src="/img/no-data.svg"
              className="mb-7 w-[200px] lg:w-[350px]"
            />
            ...
            <a
              className="mt-4 text-white cursor-pointer flex items-center rounded px-8 py-4 font-medium text-socket-btn-primary bg-pink hover:bg-socket-btn-primary-hover"
              onClick={(e) => {
                e.preventDefault();
                router.push("/");
              }}
